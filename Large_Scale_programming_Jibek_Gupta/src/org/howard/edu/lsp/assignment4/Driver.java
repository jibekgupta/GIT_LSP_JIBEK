...
/**
 * 
 * @param args, the main function serves as the entry point of the program
 */
  ...
  private void testingFunc() {
	    // Adding elements to firstSet and simultaneously testing clear
	    firstSet.add(7);
	    ...
	    try {
	      System.out.println("Largest element in fourthSet: " + fourthSet.largest());
